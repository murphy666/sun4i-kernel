...
/*FIXME: This is hardcoded because this vars are unresolved on final kernel linking 
  The values was found with :

  fb_size and fb_start from the kernel parameters of my tablet (Ainol Novo 7 Advanced) : fbmem=32M@0x5a000000
  gps and d2d from sun4i platform.h
*/

unsigned long fb_start = 0x5a000000;
unsigned long fb_size = 0x2000000;
unsigned long gps_start = 0x59000000;
unsigned long gps_size = 0x1000000;
